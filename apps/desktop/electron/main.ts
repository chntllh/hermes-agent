...
function spawnSecondaryWindow({
  ...
  profile,
  watch
}: { sessionId?: string; connectionId?: null | string; profile?: null | string; watch?: boolean } = {}) {
...
function createSessionWindow(sessionId, { connectionId = null, profile = null, watch = false } = {}) {
  return sessionWindows.openOrFocus(sessionId, () => spawnSecondaryWindow({ sessionId, connectionId, profile, watch }))
}
